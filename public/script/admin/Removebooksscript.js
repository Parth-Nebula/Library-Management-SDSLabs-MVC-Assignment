...
for (let i = 0 ; i < list_of_books.length ; i++)
{
    ...
    cell4.innerHTML = "  <form action='/removeABook' method='POST'> <div class='lineBox'> <input type='text' class='bookTitle' name='BookTitle' value='" + list_of_books[i].Title + "' style='display:none'> <input type='text' class='quantBox' placeholder ='Amount' name=QuantityFilled> <input type='submit' class='removeButton' value='Remove'> </div> </form>  ";
}